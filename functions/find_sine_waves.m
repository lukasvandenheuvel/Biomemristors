function sine_wave_indeces = find_sine_waves(V_signal, fft_peak_theshold)
    ...
    valid_window_indeces = find((fft_peak_score > fft_peak_theshold) ...
                                & (phase < 0));
    sine_wave_indeces = [zero_crossing_indeces(valid_window_indeces), ...
                          zero_crossing_indeces(valid_window_indeces+2)];
end